...
def load_or_generate_candidate_pool(
    ...
    if candidate_pool is None:
        ...
        torch.save(candidate_pool, "models/cand_pool.t7")
...
def main(params):
    ...
    if candidate_encoding is None:
        ...
        logger.info("Saving candidate encoding to file " + "models/all_entities.encoding")
        torch.save(candidate_encoding, "models/all_entities.encoding")
